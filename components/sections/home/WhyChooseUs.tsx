...
// Fallback values array in case external import is empty or undefined
const DEFAULT_VALUES = [
  {
    title: "Military SOP Governance",
    description:
      "Every security post and engineering task follows written Navy-standard protocols, not verbal assumptions.",
    icon: ShieldCheck,
  },
  {
    title: "24/7 Central Command",
    description:
      "Real-time incident tracking and automated escalation for total operational peace of mind across all sites.",
    icon: Clock,
  },
  {
    title: "100% Statutory Compliance",
    description:
      "Complete transparency across labor laws, PF, ESIC, and safety audits with live digital portal access.",
    icon: ShieldAlert,
  },
  {
    title: "Zero-Downtime MEP",
    description:
      "Preventative maintenance programs engineered to keep commercial HVAC, electrical grids, and pumps running smoothly.",
    icon: Zap,
  },
];
...
export const WhyChooseUs = () => {
  ...
  // Combine external data with default fallback data
  const valuesData =
    ...
    >
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-12">
          {/* LEFT COLUMN: Heading & Credibility Card */}
          <div className="flex flex-col gap-6 lg:col-span-5">
            <div className="why-anim-item inline-flex w-fit items-center gap-2 rounded-sm border border-sky-500/30 bg-sky-500/10 px-3.5 py-1.5 font-mono text-xs uppercase tracking-widest text-sky-400 backdrop-blur-md">
            ...
            <p className="why-anim-item text-balance text-sm leading-relaxed text-slate-300">
            ...
            {/* Military Precision Credibility Card */}
          ...
          {/* RIGHT COLUMN: Values & Capability Grid (2 Columns) */}
            ...
            {valuesData.map((value, i) => {
              ...
              return (
                <div
                  ...
                  className="why-anim-item group relative flex min-h-[200px] flex-col justify-between rounded-sm border border-slate-800 bg-slate-900/60 p-6 shadow-xl backdrop-blur-xl transition-all duration-300 hover:border-sky-500/50 hover:bg-slate-900/90"
                >
